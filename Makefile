...
MODBUILT_NAMES=      array  _asyncio  _bisect  _contextvars  _csv  _heapq  _json  _lsprof  _opcode  _pickle  _queue  _random  _struct  _typing  _xxsubinterpreters  _zoneinfo  audioop  math  cmath  _statistics  _datetime  _decimal  binascii  _lzma  zlib  readline  _md5  _sha1  _sha256  _sha512  _sha3  _blake2  pyexpat  _elementtree  _codecs_cn  _codecs_hk  _codecs_iso2022  _codecs_jp  _codecs_kr  _codecs_tw  _multibytecodec  unicodedata  _crypt  fcntl  grp  mmap  nis  ossaudiodev  _posixsubprocess  resource  select  _socket  spwd  syslog  termios  _posixshmem  _multiprocessing  _ctypes  _curses  _curses_panel  _sqlite3  _ssl  _hashlib  _uuid  xxsubtype  _xxtestfuzz  _testbuffer  _testinternalcapi  _testcapi  _testclinic  _testimportmultiple  _testmultiphase  _testsinglephase  _ctypes_test  xxlimited  xxlimited_35  atexit  faulthandler  posix  _signal  _tracemalloc  _codecs  _collections  errno  _io  itertools  _sre  _thread  time  _weakref  _abc  _functools  _locale  _operator  _stat  _symtable  pwd
...
abs_srcdir=	/home/cazoni/Desktop/finalQuickChatRepo/cpython
abs_builddir=	/home/cazoni/Desktop/finalQuickChatRepo/cpython
...
MODULE__CTYPES_CFLAGS=-I/home/linuxbrew/.linuxbrew/Cellar/libffi/3.3_4/include
MODULE__CTYPES_LDFLAGS=-L/home/linuxbrew/.linuxbrew/Cellar/libffi/3.3_4/lib/../lib -lffi -ldl
MODULE__CURSES_STATE=yes
MODULE__CURSES_CFLAGS=-D_DEFAULT_SOURCE  -I/home/linuxbrew/.linuxbrew/Cellar/ncurses/6.2/include/ncursesw -I/home/linuxbrew/.linuxbrew/Cellar/ncurses/6.2/include
MODULE__CURSES_LDFLAGS=-L/home/linuxbrew/.linuxbrew/Cellar/ncurses/6.2/lib -lncursesw

MODULE__CURSES_PANEL_STATE=yes
MODULE__CURSES_PANEL_CFLAGS=-D_DEFAULT_SOURCE  -D_DEFAULT_SOURCE  -I/home/linuxbrew/.linuxbrew/Cellar/ncurses/6.2/include/ncursesw -I/home/linuxbrew/.linuxbrew/Cellar/ncurses/6.2/include -I/home/linuxbrew/.linuxbrew/Cellar/ncurses/6.2/include/ncursesw -I/home/linuxbrew/.linuxbrew/Cellar/ncurses/6.2/include -D_DEFAULT_SOURCE  -I/home/linuxbrew/.linuxbrew/Cellar/ncurses/6.2/include/ncursesw -I/home/linuxbrew/.linuxbrew/Cellar/ncurses/6.2/include
MODULE__CURSES_PANEL_LDFLAGS=-L/home/linuxbrew/.linuxbrew/Cellar/ncurses/6.2/lib -lpanelw -L/home/linuxbrew/.linuxbrew/Cellar/ncurses/6.2/lib -lncursesw
...
MODULE_READLINE_CFLAGS=-I/home/linuxbrew/.linuxbrew/Cellar/readline/8.1/include
MODULE_READLINE_LDFLAGS=-L/home/linuxbrew/.linuxbrew/Cellar/readline/8.1/lib -lreadline
MODULE__SQLITE3_STATE=yes
MODULE__SQLITE3_CFLAGS=-I/home/linuxbrew/.linuxbrew/Cellar/sqlite/3.35.5/include -I$(srcdir)/Modules/_sqlite
MODULE__SQLITE3_LDFLAGS=-L/home/linuxbrew/.linuxbrew/Cellar/sqlite/3.35.5/lib -lsqlite3
MODULE__TKINTER_STATE=missing
MODULE__UUID_STATE=yes
MODULE__UUID_CFLAGS=-I/home/linuxbrew/.linuxbrew/Cellar/util-linux/2.36.2/include/uuid
MODULE__UUID_LDFLAGS=-L/home/linuxbrew/.linuxbrew/Cellar/util-linux/2.36.2/lib -luuid
MODULE_ZLIB_STATE=yes
MODULE_ZLIB_CFLAGS=-I/home/linuxbrew/.linuxbrew/Cellar/zlib/1.2.11/include
MODULE_ZLIB_LDFLAGS=-L/home/linuxbrew/.linuxbrew/Cellar/zlib/1.2.11/lib -lz
MODULE_BINASCII_STATE=yes
MODULE_BINASCII_CFLAGS=-DUSE_ZLIB_CRC32 -I/home/linuxbrew/.linuxbrew/Cellar/zlib/1.2.11/include
MODULE_BINASCII_LDFLAGS=-L/home/linuxbrew/.linuxbrew/Cellar/zlib/1.2.11/lib -lz
MODULE__BZ2_STATE=missing
MODULE__LZMA_STATE=yes
MODULE__LZMA_CFLAGS=-I/home/linuxbrew/.linuxbrew/Cellar/xz/5.2.5/include
MODULE__LZMA_LDFLAGS=-L/home/linuxbrew/.linuxbrew/Cellar/xz/5.2.5/lib -llzma
MODULE__SSL_STATE=yes
MODULE__SSL_CFLAGS=-I/home/linuxbrew/.linuxbrew/Cellar/openssl@1.1/1.1.1k/include
MODULE__SSL_LDFLAGS=-L/home/linuxbrew/.linuxbrew/Cellar/openssl@1.1/1.1.1k/lib  -lssl -lcrypto
MODULE__HASHLIB_STATE=yes
MODULE__HASHLIB_CFLAGS=-I/home/linuxbrew/.linuxbrew/Cellar/openssl@1.1/1.1.1k/include
MODULE__HASHLIB_LDFLAGS=-L/home/linuxbrew/.linuxbrew/Cellar/openssl@1.1/1.1.1k/lib   -lcrypto
...
CONFIG_ARGS=	 'PKG_CONFIG_PATH=/home/cazoni/.opam/4.12.1/lib/pkgconfig:'
...
BASEMODLIBS=
SHAREDMODS= Modules/array$(EXT_SUFFIX) Modules/_asyncio$(EXT_SUFFIX) Modules/_bisect$(EXT_SUFFIX) Modules/_contextvars$(EXT_SUFFIX) Modules/_csv$(EXT_SUFFIX) Modules/_heapq$(EXT_SUFFIX) Modules/_json$(EXT_SUFFIX) Modules/_lsprof$(EXT_SUFFIX) Modules/_opcode$(EXT_SUFFIX) Modules/_pickle$(EXT_SUFFIX) Modules/_queue$(EXT_SUFFIX) Modules/_random$(EXT_SUFFIX) Modules/_struct$(EXT_SUFFIX) Modules/_typing$(EXT_SUFFIX) Modules/_xxsubinterpreters$(EXT_SUFFIX) Modules/_zoneinfo$(EXT_SUFFIX) Modules/audioop$(EXT_SUFFIX) Modules/math$(EXT_SUFFIX) Modules/cmath$(EXT_SUFFIX) Modules/_statistics$(EXT_SUFFIX) Modules/_datetime$(EXT_SUFFIX) Modules/_decimal$(EXT_SUFFIX) Modules/binascii$(EXT_SUFFIX) Modules/_lzma$(EXT_SUFFIX) Modules/zlib$(EXT_SUFFIX) Modules/readline$(EXT_SUFFIX) Modules/_md5$(EXT_SUFFIX) Modules/_sha1$(EXT_SUFFIX) Modules/_sha256$(EXT_SUFFIX) Modules/_sha512$(EXT_SUFFIX) Modules/_sha3$(EXT_SUFFIX) Modules/_blake2$(EXT_SUFFIX) Modules/pyexpat$(EXT_SUFFIX) Modules/_elementtree$(EXT_SUFFIX) Modules/_codecs_cn$(EXT_SUFFIX) Modules/_codecs_hk$(EXT_SUFFIX) Modules/_codecs_iso2022$(EXT_SUFFIX) Modules/_codecs_jp$(EXT_SUFFIX) Modules/_codecs_kr$(EXT_SUFFIX) Modules/_codecs_tw$(EXT_SUFFIX) Modules/_multibytecodec$(EXT_SUFFIX) Modules/unicodedata$(EXT_SUFFIX) Modules/_crypt$(EXT_SUFFIX) Modules/fcntl$(EXT_SUFFIX) Modules/grp$(EXT_SUFFIX) Modules/mmap$(EXT_SUFFIX) Modules/nis$(EXT_SUFFIX) Modules/ossaudiodev$(EXT_SUFFIX) Modules/_posixsubprocess$(EXT_SUFFIX) Modules/resource$(EXT_SUFFIX) Modules/select$(EXT_SUFFIX) Modules/_socket$(EXT_SUFFIX) Modules/spwd$(EXT_SUFFIX) Modules/syslog$(EXT_SUFFIX) Modules/termios$(EXT_SUFFIX) Modules/_posixshmem$(EXT_SUFFIX) Modules/_multiprocessing$(EXT_SUFFIX) Modules/_ctypes$(EXT_SUFFIX) Modules/_curses$(EXT_SUFFIX) Modules/_curses_panel$(EXT_SUFFIX) Modules/_sqlite3$(EXT_SUFFIX) Modules/_ssl$(EXT_SUFFIX) Modules/_hashlib$(EXT_SUFFIX) Modules/_uuid$(EXT_SUFFIX) Modules/xxsubtype$(EXT_SUFFIX) Modules/_xxtestfuzz$(EXT_SUFFIX) Modules/_testbuffer$(EXT_SUFFIX) Modules/_testinternalcapi$(EXT_SUFFIX) Modules/_testcapi$(EXT_SUFFIX) Modules/_testclinic$(EXT_SUFFIX) Modules/_testimportmultiple$(EXT_SUFFIX) Modules/_testmultiphase$(EXT_SUFFIX) Modules/_testsinglephase$(EXT_SUFFIX) Modules/_ctypes_test$(EXT_SUFFIX) Modules/xxlimited$(EXT_SUFFIX) Modules/xxlimited_35$(EXT_SUFFIX)
...
bolt-opt: 
	rm -f *.fdata
	 ./$(BUILDPYTHON) -instrument -instrumentation-file-append-pid -instrumentation-file=$(abspath $(BUILDPYTHON).bolt) -o $(BUILDPYTHON).bolt_inst
	./$(BUILDPYTHON).bolt_inst $(PROFILE_TASK) || true
	 $(BUILDPYTHON).*.fdata > $(BUILDPYTHON).fdata
...
# This goes into $(exec_prefix)
LIBPL=		$(prefix)/lib/python3.12/config-$(VERSION)$(ABIFLAGS)-x86_64-linux-gnu
...
Modules/_typingmodule.o: $(srcdir)/Modules/_typingmodule.c $(MODULE__TYPING_DEPS) $(MODULE_DEPS_SHARED) $(PYTHON_HEADERS); $(CC) $(MODULE__TYPING_CFLAGS) $(PY_STDMODULE_CFLAGS) $(CCSHARED) -c $(srcdir)/Modules/_typingmodule.c -o Modules/_typingmodule.o
...
Modules/md5module.o: $(srcdir)/Modules/md5module.c $(MODULE__MD5_DEPS) $(MODULE_DEPS_SHARED) $(PYTHON_HEADERS); $(CC) $(MODULE__MD5_CFLAGS) $(PY_STDMODULE_CFLAGS) $(CCSHARED) -c $(srcdir)/Modules/md5module.c -o Modules/md5module.o
Modules/_md5$(EXT_SUFFIX):  Modules/md5module.o; $(BLDSHARED)  Modules/md5module.o $(MODULE__MD5_LDFLAGS)  -o Modules/_md5$(EXT_SUFFIX)
Modules/sha1module.o: $(srcdir)/Modules/sha1module.c $(MODULE__SHA1_DEPS) $(MODULE_DEPS_SHARED) $(PYTHON_HEADERS); $(CC) $(MODULE__SHA1_CFLAGS) $(PY_STDMODULE_CFLAGS) $(CCSHARED) -c $(srcdir)/Modules/sha1module.c -o Modules/sha1module.o
Modules/_sha1$(EXT_SUFFIX):  Modules/sha1module.o; $(BLDSHARED)  Modules/sha1module.o $(MODULE__SHA1_LDFLAGS)  -o Modules/_sha1$(EXT_SUFFIX)
Modules/sha256module.o: $(srcdir)/Modules/sha256module.c $(MODULE__SHA256_DEPS) $(MODULE_DEPS_SHARED) $(PYTHON_HEADERS); $(CC) $(MODULE__SHA256_CFLAGS) $(PY_STDMODULE_CFLAGS) $(CCSHARED) -c $(srcdir)/Modules/sha256module.c -o Modules/sha256module.o
Modules/_sha256$(EXT_SUFFIX):  Modules/sha256module.o; $(BLDSHARED)  Modules/sha256module.o $(MODULE__SHA256_LDFLAGS)  -o Modules/_sha256$(EXT_SUFFIX)
Modules/sha512module.o: $(srcdir)/Modules/sha512module.c $(MODULE__SHA512_DEPS) $(MODULE_DEPS_SHARED) $(PYTHON_HEADERS); $(CC) $(MODULE__SHA512_CFLAGS) $(PY_STDMODULE_CFLAGS) $(CCSHARED) -c $(srcdir)/Modules/sha512module.c -o Modules/sha512module.o
Modules/_sha512$(EXT_SUFFIX):  Modules/sha512module.o; $(BLDSHARED)  Modules/sha512module.o $(MODULE__SHA512_LDFLAGS)  -o Modules/_sha512$(EXT_SUFFIX)
Modules/_sha3/sha3module.o: $(srcdir)/Modules/_sha3/sha3module.c $(MODULE__SHA3_DEPS) $(MODULE_DEPS_SHARED) $(PYTHON_HEADERS); $(CC) $(MODULE__SHA3_CFLAGS) $(PY_STDMODULE_CFLAGS) $(CCSHARED) -c $(srcdir)/Modules/_sha3/sha3module.c -o Modules/_sha3/sha3module.o
Modules/_sha3$(EXT_SUFFIX):  Modules/_sha3/sha3module.o; $(BLDSHARED)  Modules/_sha3/sha3module.o $(MODULE__SHA3_LDFLAGS)  -o Modules/_sha3$(EXT_SUFFIX)
...
Modules/ossaudiodev.o: $(srcdir)/Modules/ossaudiodev.c $(MODULE_OSSAUDIODEV_DEPS) $(MODULE_DEPS_SHARED) $(PYTHON_HEADERS); $(CC) $(MODULE_OSSAUDIODEV_CFLAGS) $(PY_STDMODULE_CFLAGS) $(CCSHARED) -c $(srcdir)/Modules/ossaudiodev.c -o Modules/ossaudiodev.o
Modules/ossaudiodev$(EXT_SUFFIX):  Modules/ossaudiodev.o; $(BLDSHARED)  Modules/ossaudiodev.o $(MODULE_OSSAUDIODEV_LDFLAGS)  -o Modules/ossaudiodev$(EXT_SUFFIX)
...
Modules/spwdmodule.o: $(srcdir)/Modules/spwdmodule.c $(MODULE_SPWD_DEPS) $(MODULE_DEPS_SHARED) $(PYTHON_HEADERS); $(CC) $(MODULE_SPWD_CFLAGS) $(PY_STDMODULE_CFLAGS) $(CCSHARED) -c $(srcdir)/Modules/spwdmodule.c -o Modules/spwdmodule.o
Modules/spwd$(EXT_SUFFIX):  Modules/spwdmodule.o; $(BLDSHARED)  Modules/spwdmodule.o $(MODULE_SPWD_LDFLAGS)  -o Modules/spwd$(EXT_SUFFIX)
